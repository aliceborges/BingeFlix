...
export const START_LIST_MOVIES_LOADING = 'START_LIST_MOVIES_LOADING';
...
export const startListMoviesLoading = () => ({
  type: START_LIST_MOVIES_LOADING
});
...
export const fetchListMovies = () => dispatch => {
  dispatch(startListMoviesLoading());
