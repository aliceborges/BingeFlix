...
class GenreListCarousel extends React.Component {
  ...
  removeMovieFromList() {
    ...
    deleteListMovie(currentUser.id, movie.movie_id).then(response => {
      ...
      <div className="carousel-component">
        ...
        <div className="wrap">
          <div className="window">
            <span id={"prev_my_list"} onClick={() => this.shiftSlide(1)}>
            ...
            <span id={"next_my_list"} onClick={() => this.shiftSlide(-1)}>
